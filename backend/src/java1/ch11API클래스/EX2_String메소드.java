...
public class EX2_String메소드 {
	...
	public static void main(String[] args) {
		...
		if(strVar1 == strVar2) {
			...
			System.out.println("(스택 값 다르다)다른 String 객체를 참조");
		}
		
		if(strVar1.equals(strVar2) ) {
			System.out.println("(힘 값이 같다)같은 문자열을 가짐");
		}else {
			System.out.println("(힘 값이 다르다)다른 문자열을 가짐");
		}
		...
		// 4. indexOf( "문자" ) : 해당 문자의 문자 인덱스번호 찾기
		...
		System.out.println(String.valueOf(10.5) ); // 실수형 10.5 -> 문자열 10.5 출력
