...
public class EX2_연산자문제 {	// class s
	...
	public static void main(String[] args) {	// main s
		// 입력객체 [ 1번만 선언 ]
				 ...
				 */
				// 문제1 
				System.out.println("문제1) 기본급 : "); int 기본급 = scanner.nextInt();
				System.out.println("문제2) 수당 : "); 	 int 수당 = scanner.nextInt();
				...
				int 금액 = 0; 	// 변수 선언 하고 자료형 선택 : ??? 1.논리 2.정소 3. 실수 4.문자열 
				금액 = scanner.nextInt();		// 입력받은 데이터를 정수형으로 가져와서 변수에 대입
						...
						System.out.println("맞다 : " +( 금액==7 ) );	/* 문제3 */
						
						// 문제3 : 하나의 정수를 입력받아 7의 배수 이면 '맞다' 아니면 '아니다' [ if x ]
						
						// 문제 3			[ 배수 : 값수 == 0    ,  값은 그 수의 배수 ] 
						...
						// 문제 4
						System.out.print("문제4) : "); int 문제4 = scanner.nextInt();
						...
						// 문제 12
					 	System.out.print("문제12) : "); 		double inch = scanner.nextDouble();
						...
						System.out.print("기밀고사 : ");	double 기말고사 = scanner.nextInt()*0.3 ;
				...
				/*
				 	문제3 : 하나의 정수를 입력받아 7의 배수 이면 '맞다' 아니면 '아니다' [if x]
				  	문제4 : 하나의 정수를 입력받아 홀수이면 이면 '홀수' 아니면 '짝수' [if x]
				  	문제5 : 하나의 정수를 입력받아 더 큰수 출력
				  	문제6 : 두개의 정수를 입력받아 더 큰수 출력
				  	문제7 : 반지름 입력받아 원 넓이 출력하기
