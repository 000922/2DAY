package java1.ch5클래스.EX.EX7_비회원게시판;
			...
			while( true ) {
				...
				///////////////////////////////////////////////////////////////////////////////////////
					...
					if( ch2 == 1 ) { }	// 생략시 while 재반복 
						...
						if( board.password.equals(password) ) {
							// 만일 현재게시물의 비밀번호 와 입력받은 비밀번호가 같으면 [ equals ]
								...
								for( int index = select ; index<boardlist.length ; index++ ) {
									...
									if( boardlist[index+1] == null )	{ break; }	// 다음 객체가 null 이면 
								}	// for end		
						}	// if end
					}	// else end
					else if( ch2 == 3 ) {
						...
						if( board.password.equals(password) ) {
							 scanner.nextLine();
							System.out.println("수정할 제목 : ");	boardlist[select].title = scanner.nextLine();
							System.out.println("수정할 내용 : ");	boardlist[select].content = scanner.nextLine();
