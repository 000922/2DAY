...
public class EX4_배열2 {	// class s
	...
	public static void main(String[] args) {	// main s
		...
		String[] [] 배열2 = new String[10][5];			// String 객체를 20개 저장
			// 1. 항목 값 대입
			배열2[0][0] = "유재석";	배열2[0] [1]	= "3333";
			배열2[1][0] = "강호동";	배열2[1] [1]	= "3223";
			배열2[2][0] = "신동엽";	배열2[2] [1]	= "0333";
			// 2. 항목 값 수정
			배열2[0][0] = "하하";		배열2[0] [1] = "1234";
			// 3. 항목 값 삭제 [ 데이터 초기화 ]
		...
		// 3. 3차원 배열 [가로] [세로] [높이]
		String[ ] [ ] [ ] 배열3 = new String[10][2][3]; 	// String 객체를 60게 저장
