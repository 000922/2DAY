...
///////////////////////////////// 1. 사용자에게 입력받는다. [6번]///////////////////////////////////////////////////////
		for( int i = 0 ; i<6 ; i++ ) {	// i=인덱스
			System.out.println("안내) " + (i+1)+"번쨰 번호 선택 :");
			...
			if( 구매번호[i] < 1 || 구매번호[i] > 45 ) {		// 만약에 입력값이 1보다 작거나 45보다 크면 재입력 
				...
				i--;		// 현재 i 무효처리 
				continue;	// 다시 반복문 실행 --> 증감식
			}	// if end

			// [조건2] 배열내 입력된 데이터 확인 [중복확인]
			boolean 중복체크 = false;	// 중복여부 저장하는 변수
			for( int j = 0 ; j< i ; j++ ) {
				if( 구매번호[j] == 구매번호[i] ) {	// 만약에 j 번쨰 인덱스의 값과 i번쨰 인덱스와 같으면 
...
///////////////////////////////// 4. 구매번호, 추첨번호 두 배얼간 동일한 수 출력 /////////////////////////////////////////////
		...
		System.out.println("총 담청 개수 : " + 당첨개수 );
