/*
    함수 : 미리정의된 코드 
         기본형대 : 1. 매개변수 2. 정의코드 3. 린턴값 
         사용목적 : 1. 재활용 2. 메모리효율성 3.매개변수에 따른 서로 다른 리턴 값
    모양 : function 함수메ㅕㅇ ( 매개변수~ ){ 정의코드 return 리턴값 }
          매개변수 ( 인수 ) : 함수 안으로 들어오는 수 (선택사항)
             - 변수 , 상수 , 배열 , 함수 - 매개변수로 들어올수있음 자료형이면
          리턴값( 변환) : 함수 밖으로 나가는 수  ( 선택사항)
    ...
    5. 콜백함수 : 함수도 자료형이기 때문에 매개변수로 전달이 가능하다.
         ...
         * 미리 만들어진 콜백 사용하는  배열내 함수들
             ...
             filiter() : 새로운 배열 생성 [ return true 값을 새로운 배열 저장 ]
