...
if( mid != 'null'){
	...
	clientsocket.onmessage = function(e){ onmessage(e) }	// 이거 안먹힌다.
...
function onmessage(e){
	let msg = JSON.parse( e.data ) // 받은 데이터 객체	// 이거 안됨
	...
	///////////////////////////////////////////// 1. 일반 메시지 //////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////
	}else if( msg.type == 'emo'){	// 전송타입이 이모티콘 
	///////////////////////////////////////////////2.이모티콘 전송 코드 /////////////////////////////////////////
	...
	document.querySelector('.contentbox').scrollTop 
			= document.querySelector('.contentbox').scrollHight
