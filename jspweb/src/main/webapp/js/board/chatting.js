...
// 전송방식 : 1. 보내기버튼 눌렀을때 2. 메시지 입력 상자 에서 엔터를 눌렀을때
 	...
 	// 4. 메시지 받았을때 
function onmessage( e ){ // e : 받서비소켓으로 부터 받은 정보 담겨져있음
	// e.data : 받은 정보의 메시지	
	let msg = JSON.parse( e.data )	// 받은 String --> JSON 변경 
	console.log( msg )
	// 1. 출력 구역 호출
...
// 2. 메소드 구현 [ 접속했을때 , 나갔을때 , 메시지보내기 , 메시지 받았을때 ]
