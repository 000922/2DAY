///////////////////////[전역변수]/////////////////////////////////
let datalist = null	// 약국 리스트 선언만 [ 전역변수 - 여러 함수에서 같이 쓰기위해 ]
////////////////////////[함수호출]///////////////////////////
getdata()
///////////////////////////공공데이터 api 호출 ////////////////////////////////
	...
	geocoder.addressSearch( datalist[i].주소 , function(result, status) {
	    // 정상적으로 검색이 완료됐으면 
	     if (status === kakao.maps.services.Status.OK) {
			...
			kakao.maps.event.addListener(marker, 'click', function() {	// 마커 클릭이벤트 : 마커에 클릭이벤트를 등록합니다
			    detailview(i) // 약국 상세 div 출력 
			});
	        var infowindow = new kakao.maps.InfoWindow({	 // 인포윈도우 : 마커의 설명[말풍선]달기
