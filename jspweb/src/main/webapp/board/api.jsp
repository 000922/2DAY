...
<body>
	...
	<div class="container"> <!-- b:container  -->
		...
		<table class="table apitable2"> <!-- b:table -->
			
		</table>
		
	</div>

	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=41cade2051da6e259c700fdd8a673b18&libraries=services"></script>
...
<!-- 
		카카오 지도 API 주소 
		<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=41cade2051da6e259c700fdd8a673b18"></script> 
		
		<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=발급받은 APP KEY를 사용하세요&libraries=services"></script>
		JavaScript 키 :	41cade2051da6e259c700fdd8a673b18
														+ f 
 -->